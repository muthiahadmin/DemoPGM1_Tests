//PA05X05T JOB ,,CLASS=S,MSGCLASS=H,MSGLEVEL=(1,1),     
//    NOTIFY=PA05X05,TIME=5,REGION=0M                             
...
//        DD DISP=SHR,DSN=PA05X05.TEST.LOAD
//        DD DISP=SHR,DSN=SALESSUP.ISPW.SAND.DEV.LOAD.BTCH
